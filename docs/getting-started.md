...
Para a documentação completa do sistema de logging, incluindo a diferença entre
logger de trajetória e logger estruturado de runtime, veja `docs/logging.md`.
