...
def _parse_skill_file(text: str, name: str = "") -> SkillDef:
    ...
    # SIF — Skill Interface Format
    from rlm.core.skillkit.sif import parse_sif_block  # import lazy
...
class SkillLoader:
    ...
    def build_system_prompt_context(
        ...
        if plan.effective_mode == "sif":
            from rlm.core.skillkit.sif import SIFTableBuilder
    ...
    def rank_skills(self, skills: list[SkillDef], query: str = "") -> list[SkillRank]:
        ...
        from rlm.core.skillkit.skill_telemetry import get_skill_telemetry
        from rlm.core.memory.semantic_retrieval import SemanticTextIndex
    ...
    def inject_sif_callables(
        ...
        """
        from rlm.core.skillkit.sif import SIFCompositionGraph, SIFFactory
        from rlm.core.skillkit.skill_telemetry import get_skill_telemetry
        entries = [
