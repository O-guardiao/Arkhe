...
class TestSiblingMessage:
    ...
    def test_import(self):
        from rlm.core.sibling_bus import SiblingMessage
...
class TestSiblingBusPublishSubscribe:
    ...
    def test_empty_topic_is_rejected(self):
        from rlm.core.sibling_bus import SiblingBus, SiblingBusError
        bus = SiblingBus()
...
class TestSiblingBusSafetyLimits:
    ...
    def test_channel_cap_raises_sibling_bus_error(self):
        ...
        from rlm.core.sibling_bus import SiblingBus, SiblingBusError, _MAX_CHANNELS
        bus = SiblingBus()
    ...
    def test_subscribe_created_channel_is_bounded(self):
        ...
        from rlm.core.sibling_bus import SiblingBus, SiblingBusError, _CHANNEL_MAXSIZE
        bus = SiblingBus()
...
class TestSiblingBusTelemetry:
    ...
    def test_channel_reuse_after_cap_works(self):
        ...
        from rlm.core.sibling_bus import SiblingBus, _MAX_CHANNELS
        bus = SiblingBus()
        for i in range(_MAX_CHANNELS):
            bus.publish(f"topic_{i}", i)
    ...
    def test_queue_full_recovers_after_consume(self):
        ...
        from rlm.core.sibling_bus import SiblingBus, _CHANNEL_MAXSIZE
        bus = SiblingBus()
        topic = "recover_test"
        for i in range(_CHANNEL_MAXSIZE):
            bus.publish(topic, i)
    ...
    def test_payload_too_large_raises_sibling_bus_error(self):
        ...
        import sys
        from rlm.core.sibling_bus import SiblingBus, SiblingBusError, _MAX_PAYLOAD_BYTES
        bus = SiblingBus()
